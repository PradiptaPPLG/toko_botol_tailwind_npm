...
<div class="p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        ...
        <div class="bg-linear-to-br from-purple-500 to-purple-600 text-white rounded-lg shadow p-6">
            <p class="text-sm opacity-90">Status</p>
            <p class="text-2xl font-bold mt-2">✅ Operasional</p>
            <p class="text-xs mt-1 opacity-75">Global</p>
        </div>
    </div>
                ...
                <div class="bg-gray-50 rounded-lg border-2 border-gray-200 p-4 hover:shadow-lg transition-all">
                    ...
                    <div class="border-t pt-3 mt-3 space-y-1 text-sm">
                        <div class="flex justify-between">
                            <span class="text-gray-600">Harga Botol:</span>
                            <span class="font-bold"><?= rupiah($item['harga_jual']) ?></span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600">Harga Dus:</span>
                            <span class="font-bold"><?= rupiah($item['harga_dus']) ?></span>
                        </div>
                    </div>
                </div>
                <?php endforeach; ?>
