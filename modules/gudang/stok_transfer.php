                ...
                <div class="bg-white rounded-lg shadow p-4">
                    <div class="mb-4">
                        ...
                        <div class="mb-3">
                            ...
                            <select id="select-cabang-asal" onchange="loadProdukByCabang()" class="w-full border-2 border-blue-300 rounded-lg p-2 text-sm font-semibold bg-blue-50">
            ...
            <div class="lg:col-span-1">
                <div class="cart-sidebar bg-white rounded-lg shadow p-4">
                    ...
                    <div class="mb-4">
                        ...
                        <select id="select-cabang-tujuan" class="w-full border-2 border-green-300 rounded-lg p-2 text-sm font-semibold bg-green-50">
                            <?php foreach ($cabang as $c): ?>
                                <option value="<?= $c['id'] ?>"><?= $c['nama_cabang'] ?></option>
                            <?php endforeach; ?>
                        </select>
