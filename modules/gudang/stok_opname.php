...
?>
    ...
    <style>
        ...
        .close-notif-so { position: absolute; top: 5px; right: 10px; background: rgba(0,0,0,0.1); border: none; color: #666; font-size: 20px; width: 24px; height: 24px; border-radius: 50%; display: flex; align-items: center; justify-content: center; text-decoration: none; }
        .close-notif-so:hover { background: rgba(0,0,0,0.2); }
    </style>
